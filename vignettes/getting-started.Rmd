...
redeemed in order, each within a 30-second window (override with
...
Finish the chain through your currently-unlocked prefix and you
collect a length-bonus on top of the per-stage XP.
